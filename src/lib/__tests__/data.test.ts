...
describe('data (SQL)', () => {
        ...
        it('should convert DB rows to ScoutReport format', async () => {
            dbMocks.query.mockResolvedValue({
                recordset: [{
                    ...
                    scouted_by: 'Scout1',
                    auto_fuel_scored: 10,
                    auto_climb_level: 'No Attempt',
                    auto_moved: 'Yes',
                    tele_fuel_scored: 20,
                    tele_climb_level: 'Level1',
            ...
            expect(result[0].data.teleop.climb_level).toBe('Level1');
        });

        it('should parse tower levels correctly', async () => {
            dbMocks.query.mockResolvedValue({
                recordset: [
                    { frc_team: 254,  match_key: '2026txcle_qm1', driver_station: 'red1', scouted_by: 'S', auto_fuel_scored: 0, auto_climb_level: 'No Attempt', auto_moved: 'No', tele_fuel_scored: 0, tele_climb_level: 'Level3', other_notes: '', mech_failure: 'No', defender_rating: 3, trench_capable: 0, hub_control: null },
                    { frc_team: 1678, match_key: '2026txcle_qm2', driver_station: 'red1', scouted_by: 'S', auto_fuel_scored: 0, auto_climb_level: 'No Attempt', auto_moved: 'No', tele_fuel_scored: 0, tele_climb_level: 'Level2', other_notes: '', mech_failure: 'No', defender_rating: 3, trench_capable: 0, hub_control: null },
                    { frc_team: 973,  match_key: '2026txcle_qm3', driver_station: 'red1', scouted_by: 'S', auto_fuel_scored: 0, auto_climb_level: 'No Attempt', auto_moved: 'No', tele_fuel_scored: 0, tele_climb_level: 'Level1', other_notes: '', mech_failure: 'No', defender_rating: 3, trench_capable: 0, hub_control: null },
                    { frc_team: 118,  match_key: '2026txcle_qm4', driver_station: 'red1', scouted_by: 'S', auto_fuel_scored: 0, auto_climb_level: 'No Attempt', auto_moved: 'No', tele_fuel_scored: 0, tele_climb_level: 'No Attempt', other_notes: '', mech_failure: 'No', defender_rating: 3, trench_capable: 0, hub_control: null },
                ],
            });

            const result = await loadEventReports('2026txcle');
            expect(result[0].data.teleop.climb_level).toBe('Level3');
            expect(result[1].data.teleop.climb_level).toBe('Level2');
            expect(result[2].data.teleop.climb_level).toBe('Level1');
            expect(result[3].data.teleop.climb_level).toBe('No Attempt');
        });
        ...
        it('should handle blue alliance correctly', async () => {
            dbMocks.query.mockResolvedValue({
                recordset: [{
                    ...
                    auto_fuel_scored: 8, auto_climb_level: 'No Attempt', auto_moved: 'Yes', tele_fuel_scored: 15,
                    tele_climb_level: 'Level2', other_notes: '', mech_failure: 'No', defender_rating: 4,
                    trench_capable: 0, hub_control: 'Dominant',
                }],
            });
    ...
    describe('getAvailableEvents', () => {
        it('should return events from DB', async () => {
            dbMocks.query.mockResolvedValue({
                recordset: [
                    { event_key: '2026txcle', event_name: 'Space City #1' },
                    { event_key: '2026txman', event_name: 'Manor District' },
                ],
            });
